                ...
                <div class="bg-white shadow-sm ring-1 ring-gray-900/5 rounded-xl p-6">
                    ...
                    <div>
                        ...
                        <textarea name="notes" id="notes" rows="4"
                            class="mt-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">{{ old('notes', $client->notes) }}</textarea>
                    </div>
                </div>
