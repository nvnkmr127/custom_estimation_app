<x-app-layout>
    <div class="sm:flex sm:items-center sm:justify-between mb-8">
        <div>
            <h1 class="text-2xl font-bold tracking-tight text-slate-900">Edit Client</h1>
            <p class="mt-2 text-sm text-slate-500">Update client information.</p>
        </div>
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input type="text" name="property_type" id="property_type"
                                value="{{ old('property_type', $client->property_type) }}"
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea name="property_address" id="property_address" rows="2"
                                class="mt-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">{{ old('property_address', $client->property_address) }}</textarea>
                        </div>
