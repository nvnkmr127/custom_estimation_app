<x-app-layout>
    <div class="sm:flex sm:items-center sm:justify-between mb-8">
        <div>
            ...
            <p class="mt-2 text-sm text-slate-500">Update user information, role, and permissions.</p>
        </div>
    ...
    <div class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl">
        <form action="{{ route('users.update', $user) }}" method="POST" class="px-4 py-6 sm:p-8">
            @csrf
            @method('PUT')
                ...
                <div class="sm:col-span-3">
                    ...
                    <div class="mt-2">
                        <input type="number" name="max_discount_percentage" id="max_discount_percentage"
                            value="{{ old('max_discount_percentage', $user->max_discount_percentage) }}" min="0"
                            max="100" step="0.01"
