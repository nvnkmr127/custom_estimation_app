<x-app-layout>
    <div class="mb-8">
        ...
        <h1 class="mt-2 text-2xl font-bold tracking-tight text-slate-900">Add Checklist Item</h1>
    </div>

    <div class="max-w-3xl">
        <form action="{{ route('approval-checklists.store') }}" method="POST"
            ...
            <div class="px-4 py-6 sm:p-8">
                <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="sm:col-span-full">
                        ...
                        <p class="mt-1 text-sm text-gray-500">The instruction displayed to the approver (e.g. "Verify
                            client address").</p>
                    </div>
