<x-app-layout>
    <div class="sm:flex sm:items-center sm:justify-between mb-8">
        <div>
            <h1 class="text-2xl font-bold tracking-tight text-slate-900">Create Approval Chain</h1>
            <p class="mt-2 text-sm text-slate-500">Build a multi-step approval workflow for estimates.</p>
        </div>
    ...
    <form action="{{ route('approval-chains.store') }}" method="POST" x-data="approvalChainBuilder()">
        @csrf
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="3"
                                class="mt-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm"></textarea>
                        </div>
                        ...
                        <div>
                            <label for="min_discount_percentage" class="block text-sm font-medium text-gray-900">Min
                                Discount (%)</label>
                            <input type="number" name="min_discount_percentage" id="min_discount_percentage" step="0.01"
