                                ...
                                <div class="space-y-2 mb-4 max-h-48 overflow-y-auto">
                                    @foreach($checklists as $item)
                                        <label class="flex items-start gap-2 text-sm text-gray-700 cursor-pointer">
                                            ...
                                            <span class="text-left leading-tight">{{ $item->task }} @if($item->is_required) <span
                                            class="text-red-500">*</span> @endif</span>
                                        </label>
                                    @endforeach
                                </div>
                                                                    ...
                                                                    <tr class="group hover:bg-slate-50/30 transition-colors">
                                                                        <td
                                                                            ...
                                                                            <div class="flex items-start gap-4">
                                                                                ...
                                                                                @else
                                                                                    <div
                                                                                        class="h-12 w-12 bg-slate-50 rounded-lg flex items-center justify-center flex-shrink-0 ring-1 ring-slate-200 border border-dashed border-slate-300">
                                                                                ...
                                                                                <div class="min-w-0">
                                                                                    ...
                                                                                    @if($item->length && $item->width)
                                                                                        <div
                                                                                            class="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-md bg-indigo-50 text-[10px] font-bold text-indigo-700 ring-1 ring-inset ring-indigo-700/10 mb-1.5">
                                                                                            <svg class="h-3 w-3" fill="none" viewBox="0 0 24 24"
                                                                                                stroke="currentColor">
                                                                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                                                                    stroke-width="2" d="M4 7v10m16-10v10M4 12h16" />
                                                                                            </svg>
                                                                                    ...
                                                                                    <!-- Item Comment Button -->
                                                                                    <button
                                                                                        @click="openItemComments({{ $item->id }}, {{ Js::from($item->name) }}, {{ Js::from($item->comments->map(function ($c) {
                            ...
                            <thead class="bg-slate-50/50">
                                <tr>
                                    ...
                                    <th
                                        ...
                                        Price</th>
                                    <th
                                        class="px-3 py-4 text-center text-[10px] font-bold text-slate-400 uppercase tracking-widest w-32 text-center">
                                        Quantity</th>
                                    <th
                                        class="px-3 py-4 text-right text-[10px] font-bold text-slate-400 uppercase tracking-widest w-32">
                                        Total</th>
                            ...
                            <li class="relative flex gap-x-4">
                                ...
                                <div class="flex-auto py-0.5 text-xs leading-5 text-gray-500">
                                    ...
                                    @if($approval->comments)
                                        <p class="mt-1 text-slate-600 bg-slate-50 p-2 rounded border border-slate-100 italic">"{{ $approval->comments }}"</p>
                                    @endif
                                </div>
                            </li>
                        @endforeach
                                            ...
                                            <li>
                                                <div class="relative pb-8">
                                                    ...
                                                    <div class="relative flex space-x-3">
                                                        ...
                                                        <div class="flex min-w-0 flex-1 justify-between space-x-4 pt-1.5">
                                                            <div>
                                                                <p class="text-xs text-slate-500">{{ $log->description }}
                                            ...
                                            <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left w-full">
                                                ...
                                                <div class="space-y-6 text-sm max-h-[70vh] overflow-y-auto pr-2">
                                                    ...
                                                    @if(!empty($diff['overview']))
                                                        <div>
                                                            <h4 class="font-medium text-slate-900 mb-2 border-b pb-1">General
                                                                Updates</h4>
                            ...
                            <div class="flex" :class="comment.type === 'client' ? 'justify-start' : 'justify-end'">
                                <div class="max-w-[85%]">
                                    <div class="p-3 shadow-sm ring-1 ring-black/5 text-sm"
                                        ...
                                        <div class="whitespace-pre-wrap leading-relaxed" x-text="comment.comment"></div>
