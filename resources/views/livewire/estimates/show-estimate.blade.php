<div x-data="{ showVersionModal: false }">
        ...
        <div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex items-center gap-3 bg-white p-2 rounded-lg shadow-sm ring-1 ring-slate-200">
                ...
                @if($estimate->status === 'draft' || $estimate->status === 'declined' || (auth()->user()->hasRole('super_admin')))
                    ...
                    <!-- Discard Draft -->
                    <button type="button"
                        onclick="if(confirm('Are you sure you want to discard this draft? This action cannot be undone.')) { @this.discard() }"
                    ...
                    @if($estimate->status === 'waiting_approval')
                        ...
                        <div x-data="{ 
                                                                                                                                        ...
                                                                                                                                        toggleChecklist(id, checked) {
                                                                                                                                            ...
                                                                                                                                            @this.toggleChecklist(id, checked);
                                                                                                                                        },
                            ...
                            <div x-data="{ open: false }" class="relative">
                                ...
                                <div x-show="open" @click.outside="open = false"
                                    ...
                                    <div x-data="{ comments: '' }">
                                        ...
                                        <button type="button" :disabled="!canApprove" @click="@this.approve(comments)"
                        ...
                        <div x-data="{ open: false }" class="relative">
                            ...
                            <div x-show="open" @click.outside="open = false"
                                ...
                                <div x-data="{ comments: '' }">
                                    <textarea x-model="comments" placeholder="Comments..."
                                        class="w-full text-xs rounded border-gray-300 mb-2"></textarea>
                                    <button type="button" @click="@this.approve(comments)"
                    ...
                    <div x-data="{ open: false }" class="relative">
                        ...
                        <div x-show="open" @click.outside="open = false"
                            ...
                            <div x-data="{ comments: '' }">
                                ...
                                <button type="button"
                                    @click="if(comments.trim()) { @this.requestChanges(comments); } else { alert('Please describe required changes'); }"
                        ...
                        <div x-show="open" @click.outside="open = false"
                            ...
                            <div x-data="{ reason_id: '', comments: '' }">
                                ...
                                <textarea x-model="comments" required placeholder="Additional comments..."
                                    class="w-full text-sm rounded border-gray-300 mb-2"></textarea>
                                <button type="button"
                                    @click="if(reason_id && comments.trim()) { @this.reject(reason_id, comments); } else { alert('Please provide a reason and comments'); }"
                                ...
                                <div
                                    ...
                                    <div x-show="showVersionModal" @click.outside="showVersionModal = false"
                                        ...
                                        <div
                                            ...
                                            <button type="button" wire:click="createVersion"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            @if($estimate->terms)
                                <div>
                                    ...
                                    <p class="text-sm text-slate-500 leading-relaxed whitespace-pre-wrap">{{ $estimate->terms }}
                                    </p>
                                </div>
                            @endif
                        </div>
            ...
            <div class="space-y-6">
                            ...
                            @foreach($estimate->approvals->sortBy('created_at') as $approval)
                                <li class="relative flex gap-x-4">
                                    ...
                                    <div class="flex-auto py-0.5 text-xs leading-5 text-gray-500">
                                        ...
                                        <span
                                            class="block text-gray-400">{{ $approval->updated_at->format('M j, g:i A') }}</span>
                ...
                <div x-data="{ showCommentsModal: {{ $estimate->comments->where('is_read', false)->isNotEmpty() ? 'true' : 'false' }} }"
                    ...
                    <!-- Thread Modal -->
                    <template x-teleport="body">
                        <div x-show="showCommentsModal" class="relative z-50" aria-labelledby="modal-title"
                                            ...
                                            <div x-data="{ comment: '' }">
                                                <div class="relative">
                                                    ...
                                                    <div class="mt-2 flex justify-end">
                                                        <button type="button"
                                                            @click="@this.addComment(comment); comment = ''"
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                @if(auth()->id() === $estimate->created_by || auth()->user()->hasRole(['super_admin', 'admin']))
                                    @if($estimate->created_by !== $follower->id) <!-- Don't remove creator -->
                                        <button type="button"
                                            onclick="if(confirm('Remove this follower?')) { @this.removeFollower({{ $follower->id }}) }"
                            ...
                            <div x-show="showFollowerModal" @click.away="showFollowerModal = false"
                                ...
                                <div x-data="{ userId: '' }">
                                    ...
                                    <div class="mt-5 sm:mt-6 sm:grid sm:grid-flow-row-dense sm:grid-cols-2 sm:gap-3">
                                        <button type="button"
                                            @click="if(userId) { @this.addFollower(userId); showFollowerModal = false; userId = ''; } else { alert('Please select a user'); }"
                                                                    ...
                                                                    @foreach($diff['items']['removed'] as $item)
                                                                        <li
                                                                            ...
                                                                            <div class="flex justify-between items-start">
                                                                                <div>
                                                                                    <div
                                                                                        class="font-medium text-red-900 line-through">
                                                                                        {{ $item->name }}
                                                                                    </div>
        ...
        <div x-show="showVersionModal" style="display: none;" class="relative z-50" aria-labelledby="modal-title" role="dialog" aria-modal="true">
            <div x-show="showVersionModal" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="ease-in duration-200" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity"></div>

            <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
                <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    <div x-show="showVersionModal" @click.outside="showVersionModal = false" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" x-transition:enter-end="opacity-100 translate-y-0 sm:scale-100" x-transition:leave="ease-in duration-200" x-transition:leave-start="opacity-100 translate-y-0 sm:scale-100" x-transition:leave-end="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" class="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                            <div class="sm:flex sm:items-start">
                                ...
                                <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                    ...
                                    <div class="mt-2">
                                        <p class="text-sm text-gray-500">Are you sure you want to create a new version of this estimate? The current version will be archived.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="mt-5 sm:mt-6 sm:grid sm:grid-flow-row-dense sm:grid-cols-2 sm:gap-3">
                                <button type="button" wire:click="createVersion" @click="showVersionModal = false" class="inline-flex w-full justify-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 sm:col-start-2">Create Version</button>
                ...
                document.addEventListener('alpine:init', () => {
                    Alpine.data('itemCommentsModal', () => ({
                        ...
                        async submit() {
                            ...
                            try {
                                await @this.addItemComment(this.itemId, this.newComment);
                                this.newComment = '';
                        ...
                        async toggleStatus(commentId, currentStatus) {
                            try {
                                await @this.toggleCommentStatus(commentId, currentStatus);
