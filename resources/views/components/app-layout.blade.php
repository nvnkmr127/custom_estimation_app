                                ...
                                <li>
                                    <a href="{{ route('unit-types.index') }}"
                                        ...
                                        <svg class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                            stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                d="M6 13.5V3.75m0 9.75a1.5 1.5 0 010 3m0-3a1.5 1.5 0 000 3m0-3.75V16.5m12-3V3.75m0 9.75a1.5 1.5 0 010 3m0-3a1.5 1.5 0 000 3m0-3.75V16.5m-6-9V3.75m0 3.75a1.5 1.5 0 010 3m0-3a1.5 1.5 0 000 3m0-3.75V16.5" />
                                        </svg>
                                        Unit Types
                                    </a>
                                </li>
                    ...
                    @if(auth()->user()->isAdmin())
                            ...
                            <ul role="list" class="-mx-2 space-y-1">
                                ...
                                <li>
                                    <a href="{{ route('approval-checklists.index') }}"
                                        class="{{ request()->routeIs('approval-checklists.*') ? 'bg-indigo-600 text-white shadow-sm' : 'text-slate-400 hover:text-white hover:bg-slate-800/50' }} group flex gap-x-3 rounded-lg p-2 text-sm leading-6 font-medium transition-all">
                                        <svg class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                            stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <li>
                            ...
                            <ul role="list" class="-mx-2 space-y-1">
                                ...
                                <li>
                                    <a href="{{ route('automation.templates.index') }}"
                                        class="{{ request()->routeIs('automation.templates.*') ? 'bg-indigo-600 text-white shadow-sm' : 'text-slate-400 hover:text-white hover:bg-slate-800/50' }} group flex gap-x-3 rounded-lg p-2 text-sm leading-6 font-medium transition-all">
                                        <svg class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                            stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round"
