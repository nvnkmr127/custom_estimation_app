<x-app-layout>
    <div class="sm:flex sm:items-center sm:justify-between mb-8">
        <div>
            <h1 class="text-2xl font-bold tracking-tight text-slate-900">Edit Coupon Code</h1>
            <p class="mt-2 text-sm text-slate-500">Update promotional discount code.</p>
        </div>
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea name="description" id="description" rows="2"
                                ...
                                class="mt-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">{{ old('description', $coupon->description) }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white shadow-sm ring-1 ring-gray-900/5 rounded-xl p-6">
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input type="number" name="value" id="value" value="{{ old('value', $coupon->value) }}" required step="0.01"
