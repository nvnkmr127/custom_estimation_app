                                ...
                                <tr class="hover:bg-slate-50/50 transition-colors duration-150">
                                    ...
                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-slate-500">
                                        <div class="flex flex-col">
                                            <span
                                                class="font-medium text-slate-900">{{ config('app.currency_symbol', '$') }}{{ number_format($package->total_price, 2) }}</span>
                                            <span class="text-xs text-slate-500">{{ count($package->items ?? []) }}
                                                items</span>
                                        </div>
                                    </td>
                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-slate-500">
