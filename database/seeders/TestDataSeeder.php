...
class TestDataSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Create test estimates with approval workflow
        $estimate1 = Estimate::updateOrCreate(
        ...
        $estimate2 = Estimate::updateOrCreate(
        ...
        \App\Models\EstimateApproval::firstOrCreate([
        ...
        $this->command->info('Created or Updated 2 test estimates with approval chains');
